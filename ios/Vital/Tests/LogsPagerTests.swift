...
final class LogsPagerTests: XCTestCase {
    ...
    func testDietDayDataSumsMacrosAcrossMultipleEntries() {
        let goal = DietBudgetDTO(mode: "auto", goal: "general", targetKcal: 2014, protein: 150, carbs: 220, fat: 65, tdee: 2200, lowEnergyWarning: nil, consumedSource: nil, consumedSourceName: nil)
        let entries = [
    ...
    func testDietDayDataClampsRemainingAtZeroWhenEatenExceedsTarget() {
        let goal = DietBudgetDTO(mode: "auto", goal: "general", targetKcal: 1000, protein: 100, carbs: 100, fat: 50, tdee: 1800, lowEnergyWarning: nil, consumedSource: nil, consumedSourceName: nil)
        let entries = [
